					...
					<main class="p-works-contents__archive-works p-works-contents__main">
						...
						if ( have_posts() ) :
							while ( have_posts() ) :
								...
								?>
						<article>
							<a href="<?php esc_url( the_permalink() ); ?>" class="p-works-contents__archive-works-item">
								...
								<div class="p-works-contents__archive-works-body">
									<h2 class="p-works-contents__archive-works-title"><?php echo $post->post_title; ?>
									</h2>
									<div class="p-works-contents__meta p-works-contents__archive-works_meta">
										<img class="p-works-contents__time-icon"
											...
											alt="">
										<time class="p-works-contents__meta-time"><?php the_time( 'Y.m.d' ); ?></time>
									</div>
								</div>
							</a>
						</article>
